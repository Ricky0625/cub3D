...
/*   Updated: 2023/07/05 18:00:26 by wricky-t         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	play_animation(t_cub *cub)
{
	...
	if (index >= 5 || index == -1)
		mlx_put_image_to_window(cub->mlx, cub->win,
			cub->hand_animation[0].ref, WIN_WIDTH - 500, WIN_HEIGHT - 480);
	else
	{
		mlx_put_image_to_window(cub->mlx, cub->win,
			cub->hand_animation[index].ref, WIN_WIDTH - 500, WIN_HEIGHT - 480);
